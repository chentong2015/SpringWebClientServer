...
// Spring WebClient & Reactive ClientRequest 废弃之前的Spring AsyncRestTemplate
// Dependencies: spring-webflux & reactor-core
public class BaseSpringWebClient {
    ...
    public void consumeServerSentEvent() {
        ...
        // 这里和SSE Server端定义的返回类型是一致的，提供body to flux的映射
